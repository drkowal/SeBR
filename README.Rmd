...
knitr::opts_chunk$set( # github_document
  collapse = TRUE,
  comment = "#>"
)
```
...
Given paired data $(x_i,y_i)$, the package `SeBR` implements efficient and fully Bayesian inference for *semiparametric regression models* that incorporate (1) an unknown data transformation 
